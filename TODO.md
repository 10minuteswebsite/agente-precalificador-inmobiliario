...
- **TODO-043 — Publicar paquete o endpoint versionado** cuando el contrato y las pruebas de integración estén aprobados. Preparación del paquete y workflow de publicación completados (`npm pack --dry-run`); falta configurar el trusted publisher de npm y autorizar la primera etiqueta.
